## 4.2 Lesson Plan: Pandas Review Day (6:30 PM)
...
* The goal is to practice coding in Pandas to the point where all of the syntax of the language just falls to the subconscious. This allows you to use your mental power on problem solving and not on basic things like how to type a list or dictionary.
