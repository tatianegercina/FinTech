...
def initialize(cash=None):
    ...
    return db, account, data_stream, signals_stream, dashboard, model
...
db, account, data_stream, signals_stream, dashboard, model = initialize(10000)
dashboard.servable()
...
async def main():
    ...
    while True:
        ...
        if df.shape[0] >= min_window:
            ...
            account = execute_trade_strategy(signals, account, model)
