...
In this activity, students will be given a list of trading function names and will be asked to propose the correct order of such functions if implemented in an algorithmic trading application.
...
### 3. Instructor Do: Trading Functions Review (10 mins)
