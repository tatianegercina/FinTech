### 3. Student Do: Smart Contracts in Action (15 mins)

In this activity, students will analyze several use cases to explore that correspond with popular types of smart contracts like tokens, notaries, supply chain, digital marketplaces, etc.
