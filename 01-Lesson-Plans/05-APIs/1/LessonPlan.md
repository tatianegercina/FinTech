...
* Slack out the [Alpaca Installation Guide](). Tell students to complete the installation and verify it with a TA before the end of the next class. This should help catch installation issues with Alpaca outside of class time.
