...
* Slack out the [Anaconda Installation Guide](../../02-Python/Supplemental/AnacondaInstallGuide.md). Tell students to complete the installation and verify it with a TA before the end of the next class. This should help catch installation issues with Python outside of class time.
...
* While later units and activities will utilize more advanced tools and technical concepts (APIs, algorithmic trading, etc.), today's lesson will start small. We'll begin by practicing the fundamentals of technical programming so that you can start your FinTech journey.
...
* You will get started with Anaconda, a free and open-source distribution of the Python programming language for scientific computing that is broadly used by data scientists and FinTech professionals.

* To have a better organization of your work, you will also learn to create an Anaconda virtual environment, a managed file space that exists as its isolated environment with corresponding dependencies, residing on a physical computer.
...
Encourage students and get them excited about the lesson. Reiterate that today will be a crash course in both hard and soft skills: students will learn technical skills and contextual knowledge to aid them in their future careers in FinTech.
...
Open the slideshow, move to the "Introduction to the Command Line" section and use the slides as you present the following questions and answers:
...
* **Version control** systems are software that helps you track changes you make in your code over time. As you edit your code, you tell the version control system to take a snapshot of your files. The version control system saves that snapshot permanently so you can recall it later if you need it.
...
* Choose your Excel file in the dialogue box.
...
* The remainder of the class will be a deep dive into FinTech's past, present, and future.
...
In this section, give students a summary of some of the critical factors leading to the growth of the FinTech space. Understanding the historical background of FinTech, as well as its current trajectory, will give students knowledge that will help them both in employer interviews and their FinTech career.

Open the lesson slides, move to the "Evolution of FinTech" section and go through the slides while reviewing the following key historical factors leading to the present-day FinTech boom.

* Mobile Infrastructure and Shifting Consumer Preferences

  * With the advancements in mobile network infrastructure (2G, 3G, 4G LTE, 5G), consumers have become more connected to the internet (as well as each other) than ever before.
  ...
  * Therefore, companies have been forced to make significant investments in technology to stay competitive with their industry peers. Consumers have more product choices and are loyal to companies they trust. Therefore, the technological channels affecting consumer engagement have a direct impact on a company's ability to market itself and, ultimately, capitalize on demand.
...
* Big Data
  ...
  * Because big data processing has become more efficient, the time needed to curate and analyze data has also decreased. Therefore, modern-day companies can employ tactics like machine learning to drive business decision-making in real-time.
...
Open the lesson slides, move to the "FinTech Domains" section and ask the students the following questions:
...
* How did these technologies allow for the disruption of traditional finance?
  ...
  **Sample Answer:** Blockchain allows for cheaper and more secure transactional validation. Robo advisors utilize machine learning algorithms for portfolio management, thereby reducing overhead costs. Payment applications use modern infrastructure such as mobile and cloud-based networking.
...
* The field of FinTech is so vast and rapidly changing due to technological innovation that even entire domains of the FinTech ecosystem have begun to change how companies operate and compete with their peers.

* To complete the Unit 1 homework assignment (FinTech case study), you will need to comprehend the nature of the FinTech domains as well as the competitive factors affecting the underlying companies within those domains. Therefore, we will need to take a closer look at the FinTech landscape.
...
Start this activity by asking students the following questions:

* Did you find any of the FinTech domains, companies, or technologies to be confusing?

* Did you find anything notable or exciting while researching the FinTech domains?

If students are confused or want more information, open the lesson slides in the slideshow appendix and review the following FinTech domains and trends.
...
* You can send any relevant documents (containing FinTech domain information) to your peer group members to facilitate quicker and easier information transfer.
...
* This activity intended to provide you with not only the breadth but also the depth of knowledge for each FinTech domain. This knowledge will prove valuable when applying for roles within the FinTech industry.

* It's not enough to simply restate the past; you should also analyze and predict the future. After completing this activity, you should have a general idea about the trends affecting each FinTech domain as well as the potential outcomes that may result in each domain in the near future.
