...
* Let students know a student guide for each unit can be found in the corresponding unit's supplemental folder. Each guide has helpful links and FAQs for the unit. The Unit 1 student guide can be found [here.](../Supplemental/StudentGuide.md) If you have any recommendations for additional questions, feel free to log an issue or a pull request with your desired additions.
