...
* When going over course requirements, be sure to emphasize that course requirements expressly prohibit cheating or plagiarism of any kind throughout this course. Engaging in cheating or plagiarism could endanger the eligibility for certification upon graduation.
...
When you and the TA's introduce yourself, feel free to include the topics below. However, be sure to keep your introduction brief, as there is a great deal to cover in this first session.
...
### 2. Instructor Do: Defining Fintech (20 mins)
...
### 3. Instructor Do: Course Overview (10 mins)
...
### 6. Instructor Do: The Rise of FinTech (10 mins)
...
### 7. Student Do: FinTech and Me (5 mins)
...
Review each question. Ask for a few volunteers for each of the response questions. Encourage students who had interesting responses in the previous activity to share out.
...
### 9. Student Do: Lending Thought Experiment (30 mins)

In this activity, students will once again break off into groups of `2-4` to devise a solution to the traditional borrowing/lending finance problem that FinTech has come to solve. This group thought experiment should put students in the mindset of how technology has been applied to bolster the financial services industry.

**File:** [README.md](Activities/02-Stu_FinTech_Thought_Experiment/README.md)

---

### 10. Instructor Do: Review Lending Thought Experiment  (20 mins)

**File:** [slideshow-placeholder]()

* Give each group `3-4` minutes (adjust based on the class size and remaining time) to briefly explain their solution and how it solves the traditional lending problem.
