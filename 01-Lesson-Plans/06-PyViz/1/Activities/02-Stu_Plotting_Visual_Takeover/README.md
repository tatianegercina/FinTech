...
Open the [starter file](Unsolved/plotting_visual_takeover.ipynb) and code the following steps. The visualizations created below should use the starter DataFrame titled `top_20_market_cap` provided in the notebook.
