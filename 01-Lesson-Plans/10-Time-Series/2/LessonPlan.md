...
* The slides for this lesson can be viewed on Google Drive here: [10.2 Lesson Slides](https://docs.google.com/presentation/d/1aNS4Leh9hI1gIUayvBRnOV3v_1o3-JirH-a6AwfyTo8/edit?usp=sharing).
...
Explain that GARCH models volatility. Open the slideshow, navigate to the GARCH section, and summarize the key features of the ARMA model:
