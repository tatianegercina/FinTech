...
- pct*change() is another way to make a series stationary. The difference between diff() is that pct_change() essentially normalizes the data (\_i.e., with the denominator doing the scaling*).
