...
To understand Amazon Lex, its important to first understand what a conversational user interface is. Have you ever wondered why you can't just *tell* your computer what to *do*?  A conversational user interface - commonly known as a chatbot - is an application that allows just that. With chatbots, users can interact with machines using normal human language. Though the idea of conversational user interfaces has been around for a very long time - think *Space Odyssey: 2001* and *HAL* - its only been in the recent past that NLP technology has become advanced enough to make practical applications of the tech a reality.
