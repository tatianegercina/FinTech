...
Today's class will introduce students to **sentiment analysis**, one of the most popular applications of NLP. Normally sentiment analysis is related to marketing, however it's receiving a big attention on FinTech because of its huge spectrum of applications ranging from customer service, competition bench-marking, investment assistance, as well as news and social media analysis.
...
* Students will use the **IBM Tone Analizer** cloud service on this class, the registration process could be time consuming, so be sure to get familiar with the process by your own before class to assist students on the process.
...
### 3. Instructor Do: Terms relevance (Understanding TF-IDF) (15 mins)
...
### 4. Student Do: Bossy Words (20 mins)
...
### 5. Instructor Do: Review Bossy Words (10 mins)
...
### 7. Student Do: The Voice of the Crisis (15 mins)
...
### 11. Students Do: The Feelings of the Crisis (20 mins)
...
### 13. Instructor Do: Tone Analysis (20 mins)
...
Inform students that they will use this cloud service on the next class. Slack out the Tone Analyzer docs for the [`tone()`](https://cloud.ibm.com/docs/services/tone-analyzer?topic=tone-analyzer-utgpe) and [`tone_chat()`](https://cloud.ibm.com/docs/services/tone-analyzer?topic=tone-analyzer-utco) methods and close the activity by answering any reminder question.

---

### 14. Instructor Do: Recap (10 mins)
